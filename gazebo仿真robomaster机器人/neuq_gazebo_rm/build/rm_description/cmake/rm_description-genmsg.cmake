...
set(MSG_I_FLAGS "-Irm_description:/home/fjj/neuq_gazebo_rm/neuq_gazebo_rm/src/rm_description/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/fjj/neuq_gazebo_rm/neuq_gazebo_rm/src/rm_description/msg/pw.msg" NAME_WE)
add_custom_target(_rm_description_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rm_description" "/home/fjj/neuq_gazebo_rm/neuq_gazebo_rm/src/rm_description/msg/pw.msg" ""
)
...
_generate_msg_cpp(rm_description
  "/home/fjj/neuq_gazebo_rm/neuq_gazebo_rm/src/rm_description/msg/pw.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rm_description)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rm_description\")")
  # install generated code
  install(
